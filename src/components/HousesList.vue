...
.house-details-numbers div{
    padding-top: 2%;
    border-top: solid 1px rgba(192, 195, 196, 0.863);
}
.border-right{
    border-right: solid 1px rgba(192, 195, 196, 0.863);
}
.border-left{
    border-left: solid 1px rgba(192, 195, 196, 0.863);
}
